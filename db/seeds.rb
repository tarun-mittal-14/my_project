...
User.create(name: "tarun mittal", email: "tarun@gmail.com", password: "tarun
123", age: "25", experience: "5 years", qualification: "MCA" , type: "Recruiter")
...
Job.create( title: "Developer", description: "Software developer",
 requirement: "knowledge of full stack ", location: "indore", user_id: "1")

Job.create( title: "Product Manager", description: "Lead the development of innovative products ",
 requirement: "Strong communication and project management skills ", location: "indore", user_id: "1")

Job.create( title: "Data Scientist", description: "Extract insights from complex datasets",
 requirement: "Experience with machine learning and data visualization. ", location: "indore", user_id: "2")

Job.create( title: "DevOps Engineer", description: "Build and maintain deployment pipelines",
 requirement: "Expertise in containerization and CI/CD tools ", location: "indore", user_id: "2")
